...
class Msp430Gcc < Formula
  ...
  depends_on 'nsaitonmiri/msp430/msp430-binutils'
  depends_on 'gmp'
  depends_on 'mpfr'
  depends_on 'libmpc'
  ...
  def install
    ...
    cd 'build' do
      ...
      msp430mcu = Formula.factory('nsaitonmiri/msp430/msp430mcu')
      msp430_binutils = Formula.factory('nsaitonmiri/msp430/msp430-binutils')
